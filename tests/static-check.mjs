...
for(const page of pages){
  ...
  assert.match(html,/app-theme\.css\?v=49/);
  assert.match(html,/app-enhancements\.js\?v=49/);
}
...
for(const asset of ["index.html","move-in.html","move-out.html","app-theme.css?v=49","app-enhancements.js?v=49"]){
